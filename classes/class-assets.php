				...
				'localize'     => array(
					...
					'data' => array(
						...
						'errorMessages' => array(
							...
							'connection'    => esc_html__( 'An error has occured, please refresh the page and try again.', 'ps-tec-gateway' ),
							'createOrder'   => esc_html__( 'There was an error creating your order, please try again or contact the website administrator for assistance.', 'ps-tec-gateway' ),
						),
					),
				),
			)
