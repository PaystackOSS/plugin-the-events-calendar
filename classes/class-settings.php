...
class Settings extends Abstract_Settings {
	...
	public function get_guidance_html() {
		if ( $this->account_is_in_north_america() ) {
			...
			$message = sprintf(
			// Translators: %s: The paystack telephone number.
				esc_html__( 'Please call a paystack support representative at %s', 'event-tickets' ),
				$telephone
			);
		} else {
			$message = esc_html__( 'Please reach out to paystack support from your paystack account Resolution Center', 'event-tickets' );
		}
