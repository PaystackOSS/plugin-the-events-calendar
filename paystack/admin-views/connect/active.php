...
<div class="tec-tickets__admin-settings-tickets-commerce-gateway-connected">
	<h3><?php esc_html_e( 'Additional Settings', 'ps-tec-gateway' ); ?></h3>
	<?php
...
<fieldset id="tribe-field-ticket-display-tickets-left-threshold" class="tribe-field tribe-field-text tribe-size-small">
	...
	<div class="tribe-field-wrap">
		...
		<p class="tooltip description"><?php echo esc_html_e( 'To avoid situations where bad network makes it impossible to verify transactions, copy this URL and add it to the ', 'ps-tec-gateway' ); ?><a target="_blank" href="https://dashboard.paystack.com/#/settings/developer"><?php echo esc_html_e( 'developer settings', 'ps-tec-gateway' ); ?></a><?php echo esc_html_e( ' on your Paystack Dashboard', 'ps-tec-gateway' ); ?></p>
	</div>
</fieldset>
